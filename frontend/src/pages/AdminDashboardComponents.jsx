...
<<<<<<< HEAD
                <div style={{ maxHeight: '700px', overflowY: 'auto' }}>
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <thead style={{ backgroundColor: 'var(--admin-bg)', position: 'sticky', top: 0 }}>
                            <tr>
                                <th style={{ padding: '16px', textAlign: 'left', fontSize: '12px', color: 'var(--admin-text-muted)' }}>REF #</th>
                                <th style={{ padding: '16px', textAlign: 'left', fontSize: '12px', color: 'var(--admin-text-muted)' }}>GUEST</th>
                                <th style={{ padding: '16px', textAlign: 'left', fontSize: '12px', color: 'var(--admin-text-muted)' }}>SUITE</th>
                                <th style={{ padding: '16px', textAlign: 'left', fontSize: '12px', color: 'var(--admin-text-muted)' }}>STAY DATES</th>
                                <th style={{ padding: '16px', textAlign: 'center', fontSize: '12px', color: 'var(--admin-text-muted)' }}>STATUS</th>
                            </tr>
                        </thead>
                        <tbody>
                            {reservations.map(res => (
                                <tr key={res.id} style={{ borderBottom: '1px solid var(--admin-border)' }}>
                                    ...
                                    <td style={{ padding: '16px', textAlign: 'center' }}>
                                        <span style={{ fontSize: '10px', fontWeight: 700, padding: '4px 8px', borderRadius: '40px', background: res.isPaid ? '#dcfce7' : '#fee2e2', color: res.isPaid ? '#166534' : '#991b1b' }}>
                            ...
                            {reservations.length === 0 && (
                                <tr>
                                    <td colSpan="5" style={{ padding: '40px', textAlign: 'center', color: 'var(--admin-text-muted)' }}>No records synchronized yet.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
